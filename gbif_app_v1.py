...
# Load data and assign selected province and species
data = load_data(region)
selected_province = region  # Assign region to selected_province to use it in the map function
...
if not data.empty:
    plot_map(data, selected_species, selected_province)  # Pass the third argument here
